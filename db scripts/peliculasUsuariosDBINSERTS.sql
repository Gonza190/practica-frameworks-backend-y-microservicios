...
-- Usuarios
INSERT INTO users (idUsuario, username, password, correo, enable) values 
(1, "admin", "admin", "admin@uah.es",1),
(2, "usuario1", "usuario1", "usuario1@uah.es",1);

-- Criticas
INSERT INTO criticas (idCritica, idPelicula, valoracion, nota, fecha, Users_idUsuario)  values 
...
INSERT INTO users_has_authorities (Users_idUsuario, Authorities_idRol) values
(1,1),
(2,2);
