...
('Supersalidos', 2007, 114, 'Estados Unidos', 'Greg Mottola', 'Comedia','En una de sus últimas noches como estudiantes de instituto, Evan (Michael Cera) y Seth (Jonah Hill), dos amigos inadaptados, tropezarán con diversas dificultades para comprar bebidas para una fiesta a la que han invitado a las chicas de sus sueños. En su peripecia les acompañará el indescriptible McLovin (Christopher Mintz-Plasse), otro inadaptado que acaba de comprarse un carnet falso para que le sirva de salvoconducto en la compra de alcohol.','https://pics.filmaffinity.com/superbad-543132496-mmed.jpg'),
('Zoolander', 2001, 89, 'Estados Unidos', 'Ben Stiller', 'Comedia','Derek Zoolander (Stiller) ha sido el modelo masculino más cotizado durante los últimos tres años. La noche de la gala que podría suponer su cuarta corona, el galardón se lo lleva un nuevo modelo llamado Hansel (Wilson). Derek queda en entredicho y como un idiota, y decide retirarse. Sin embargo, un prestigioso diseñador le pide que desfile para él.','https://pics.filmaffinity.com/zoolander-604094084-mmed.jpg'),
('American Psycho', 2000, 101, 'Estados Unidos', 'Mary Harron', 'Drama, Terror','En la década de 1980, Patrick Bateman es un exitoso "yuppie" obsesionado por la competencia y por la perfección material, que utiliza los más caros cosméticos masculinos, equipos de gimnasia, solárium y demás maquinaria estética para lograr un cuerpo atlético y bien acicalado, identificador material del éxito social.','https://pics.filmaffinity.com/american_psycho-503776720-mmed.jpg'),
('El lobo de Wall Street', 2013, 179, 'Estados Unidos', 'Martin Scorsese', 'Comedia, Drama','La historia del corredor de bolsa neoyorquino Jordan Belfort, quien, con poco más de veinte años, fue apodado "el lobo de Wall Street" por su enorme éxito y fortuna como fundador de la agencia bursátil Stratton Oakmont.','https://pics.filmaffinity.com/the_wolf_of_wall_street-675195906-mmed.jpg'),
